...
<script>
	function checkInfo(){
		if(document.getElementById("custno").value==0){
		...
		}else if(document.getElementById("custname").value.length>5){
			alert("회원이름이 너무 깁니다.");
			document.getElementById("custname").focus();
			...
			document.insert.action="insertPro.jsp";
	...
	<section>
		...
		<form name="insert">
			<table border="1">
				<tr>
					<td>회원번호(자동발생)</td>
					<td><input type="text" id="custno" name="custno" value="<%=dao.count()%>" readonly></td>
				</tr>
				<tr>
					<td>회원성명</td>
				...
				<tr>
					<td>가입일자</td>
					<td><input type="text" id="joindate" name="joindate" value="ex)20191007"></td>
				</tr>
				<tr>
